...
Game_Action.prototype.makeDamageValue = function(target, critical) {
    ...
    if ($gameVariables.value(91) == 999) {
　　　　////
    　　$gameVariables.setValue(92,value);
    }else{
        $gameVariables.setValue(92,0);
...
　　////
　　if (this._actorId == 1 && $gameSwitches.value(317) && $gameSwitches.value(59)) $gameVariables.setValue(155, $gameVariables.value(155) + 1);

...
////-------------------------------------------------------------
//-------------------------------------------------------------
Window_Base.prototype.bbGaugeColor1 = function() {
    return this.textColor(30);
};

Window_Base.prototype.bbGaugeColor2 = function() {
    return this.textColor(31);
};

Window_Base.prototype.bbCostColor = function() {
    return this.textColor(31);
};
//-------------------------------------------------------------
////-------------------------------------------------------------
...
Window_Base.prototype.drawActorMp = function(actor, x, y, width) {
    ...
    ////
    this.drawCurrentAndMax(actor.mp, $gameVariables.value(100), x, y, width,
...
Window_Base.prototype.drawActorbb = function(actor, x, y, width) {
    ...
    var color2 = this.tpGaugeColor2();
    this.drawGauge(x, y, width, ($gameVariables.value(83) / 100), color1, color2);
    this.changeTextColor(this.systemColor());
    if ($gameSwitches.value(73) == true) {
        ////
        if ($gameActors.actor(1)==actor) {
            this.drawText("恐", x, y, 44);
        }
    } else {
        ////
        if ($gameActors.actor(1)==actor) {
            this.drawText("Fear", x, y, 44);
        }
    }

    this.changeTextColor(this.tpColor(actor));
    this.drawText($gameVariables.value(83), x + width - 65, y, 64, 'right');
};
////-------------------------------------------------------------
//-------------------------------------------------------------
...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    if ($gameActors.actor(1)==actor) {
        ...
        this.drawActorbb(actor, x2, (y + lineHeight * 4)-21, width2);
    } else {
        this.drawActorHp(actor, x2, y + lineHeight * 1, width2);
    }
};
...
Window_MenuStatus.prototype.drawItemImage = function(index) {
    ...
    this.drawActorFace(actor, rect.x + 1, rect.y + 20, Window_Base._faceWidth, Window_Base._faceHeight);
    this.changePaintOpacity(true);
};
...
Window_MenuStatus.prototype.drawItemStatus = function(index) {
    ...
    var y = rect.y + rect.height / 3 - this.lineHeight() * 1.5;
...
Window_Status.prototype.refresh = function() {
    ...
    if (this._actor) {
        ...
        this.drawHorzLine(lineHeight-20 * 1);
        this.drawBlock2(lineHeight + 15);
        this.drawBlock3(lineHeight * 6);
        this.drawBlock4(lineHeight * 9);
    }
};
...
//ステータス　ブロック３　パラメータ、装備など
Window_Status.prototype.drawBlock3 = function(y) {
    this.drawParameters(48, y);
    this.drawEquipments(432, y);
};

//ステータス　ブロック４　プロフィール（未使用）
...
Window_Status.prototype.drawParameters = function(x, y) {
    ...
    if ($gameActors.actor(1)==this._actor) {
        ...
        this.drawText("退治したゴースト数", x, y + lineHeight * 0, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(101), x + 180, y + lineHeight * 0, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("体", x + 250, y + lineHeight * 0, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("失神回数", x, y + lineHeight * 1, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(102), x + 180, y + lineHeight * 1, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 1, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("ゴーストに犯された回数", x, y + lineHeight * 2, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(103), x + 180, y + lineHeight * 2, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 2, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("大珍 四児流に犯された回数", x, y + lineHeight * 3, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(104), x + 180, y + lineHeight * 3, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 3, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("中出し回数", x, y + lineHeight * 4, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(105), x + 180, y + lineHeight * 4, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 4, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("ぶっかけ回数", x, y + lineHeight * 5, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(106), x + 180, y + lineHeight * 5, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 5, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("オナニー回数", x, y + lineHeight * 6, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(107), x + 180, y + lineHeight * 6, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 6, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("ゴーストとセックスした回数", x, y + lineHeight * 7, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(123), x + 180, y + lineHeight * 7, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 7, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("失禁回数", x, y + lineHeight * 8, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(108), x + 180, y + lineHeight * 8, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 8, 0);

    } else {
    ////-------------------------------------------------------------

        this.changeTextColor(this.systemColor());
        this.drawText("四鬼谷 雪を犯した回数", x, y + lineHeight * 0, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(104), x + 180, y + lineHeight * 0, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 0, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("四鬼谷 雪にフェラさせた回数", x, y + lineHeight * 1, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(109), x + 180, y + lineHeight * 1, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 1, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("オナニー回数", x, y + lineHeight * 2, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(111), x + 180, y + lineHeight * 2, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 2, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("ゴーストとセックスした回数", x, y + lineHeight * 3, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(112), x + 180, y + lineHeight * 3, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("回", x + 250, y + lineHeight * 3, 0);

        this.changeTextColor(this.systemColor());
        this.drawText("排出した精液の総量", x, y + lineHeight * 4, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(113), x + 180, y + lineHeight * 4, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("cc", x + 250, y + lineHeight * 4, 0);
    ...
    if ($gameActors.actor(1)==this._actor) {
        ...
        this.drawText("Number of ghosts exterminated", x, y + lineHeight * 0, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(101), x + 180, y + lineHeight * 0, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Syncope", x, y + lineHeight * 1, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(102), x + 180, y + lineHeight * 1, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Rape(Ghost)", x, y + lineHeight * 2, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(103), x + 180, y + lineHeight * 2, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Rape(Shikoru)", x, y + lineHeight * 3, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(104), x + 180, y + lineHeight * 3, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Pies", x, y + lineHeight * 4, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(105), x + 180, y + lineHeight * 4, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Bukkake", x, y + lineHeight * 5, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(106), x + 180, y + lineHeight * 5, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Masturbation", x, y + lineHeight * 6, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(107), x + 180, y + lineHeight * 6, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Sex(Ghost)", x, y + lineHeight * 7, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(123), x + 180, y + lineHeight * 7, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Incontinence", x, y + lineHeight * 8, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(108), x + 180, y + lineHeight * 8, 60, 'right');
    ...
    ////-------------------------------------------------------------
        ...
        this.changeTextColor(this.systemColor());
        this.drawText("Rape(Yuki)", x, y + lineHeight * 0, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(104), x + 180, y + lineHeight * 0, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Blowjob(Yuki)", x, y + lineHeight * 1, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(109), x + 180, y + lineHeight * 1, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Masturbation", x, y + lineHeight * 2, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(111), x + 180, y + lineHeight * 2, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Sex(Ghost)", x, y + lineHeight * 3, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(112), x + 180, y + lineHeight * 3, 60, 'right');

        this.changeTextColor(this.systemColor());
        this.drawText("Semen Total", x, y + lineHeight * 4, 160);
        this.resetTextColor();
        this.drawText($gameVariables.value(113), x + 180, y + lineHeight * 4, 60, 'right');
        this.changeTextColor(this.systemColor());
        this.drawText("cc", x + 250, y + lineHeight * 4, 0);
...
Window_Status.prototype.drawExpInfo = function(x, y) {
    ...
    if ($gameActors.actor(1)==this._actor) {
        ...
        this.drawText('-', x, y + lineHeight * 0, 270, 'right');
        this.drawText('-', x, y + lineHeight * 1, 270, 'right');
    }

　　////
    this.drawActorIcons(this._actor, x, (y + lineHeight * 3));
};
////-------------------------------------------------------------
//-------------------------------------------------------------
...
Window_BattleLog.prototype.wait = function() {
    ...
    this._waitCount = this.messageSpeed()*0.4;
...
Window_BattleStatus.prototype.drawBasicArea = function(rect, actor) {
    ...
    this.drawActorIcons(actor, rect.x + 0, rect.y+42, rect.width);
...
Window_BattleStatus.prototype.drawGaugeAreaWithTp = function(rect, actor) {
    ...
    ////
    this.drawActorbb(actor, rect.x + 357, rect.y, 96);

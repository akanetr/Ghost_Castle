...
Window_MenuCommand.prototype.createCommand = function(i) {
    ...
    //変更 オリジナルコマンド箇所を英語化
    if (i === 18 && $gameSwitches.value(73) == false) {
        this.addCommand('Standing pictures', symbol, enabled, ext);
    } else if (i === 19 && $gameSwitches.value(73) == false) {
        this.addCommand('Conversation', symbol, enabled, ext);
    } else if (i === 21 && $gameSwitches.value(73) == false) {
        this.addCommand('Equip Manual', symbol, enabled, ext);
    } else if (i === 52 && $gameSwitches.value(73) == false) {
        this.addCommand('Buy and Sell', symbol, enabled, ext);
    } else if (i === 53 && $gameSwitches.value(73) == false) {
        this.addCommand('Synthetic', symbol, enabled, ext);
    } else if (i === 54 && $gameSwitches.value(73) == false) {
        this.addCommand('Ghost Book', symbol, enabled, ext);
    } else if (i === 55 && $gameSwitches.value(73) == false) {
        this.addCommand('Lust', symbol, enabled, ext);
    } else if (i === 56 && $gameSwitches.value(73) == false) {

...
Imported.TerraxLighting = true;
	...
	var Terrax_tint_speed = 30;
	var Terrax_tint_target = '#333333';
...
(function() {
	...
	var mogdebug = false;
	var terrax_tint_speed_old = 30;
	var terrax_tint_target_old = '#333333'
	var tileglow = 0;
			...
			if ($gameVariables.GetStopScript() == false) {
				...
				if ($gameVariables.GetScriptActive() == true && $gameMap.mapId() >= 0) {
					...
					if (darkenscreen == true) {
						...
						if (firstrun === true) {
							Terrax_tint_speed = 30;
							Terrax_tint_target = '#333333';
							terrax_tint_speed_old = 30;
							terrax_tint_target_old = '#333333';
	...
	Game_Variables.prototype.GetTint = function() {
		return this._Terrax_Tint_Value || '#333333';
	};
	...
	Game_Variables.prototype.GetTintTarget = function() {
		return this._Terrax_TintTarget_Value || '#333333';
	};
	...
	Game_Variables.prototype.GetDaynightColorArray = function() {
		var default_color = [  '#333333', '#333333', '#333333', '#333333',
		  					    '#333333', '#333333', '#666666', '#AAAAAA',

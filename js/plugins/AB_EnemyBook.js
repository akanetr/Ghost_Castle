...
//=============================================================================
	...
	Window_EnemyBookStatus.prototype.refresh = function() {
		...
		if (!isUnknownEnemy && DispDescribe) {
			this.drawTextEx(dataEnemy.meta.desc1, x, (y+100) + lineHeight * 0);
			this.drawTextEx(dataEnemy.meta.desc2, x, (y+100) + lineHeight * 1);
			this.drawTextEx(dataEnemy.meta.desc3, x, (y+100) + lineHeight * 2);
			this.drawTextEx(dataEnemy.meta.desc4, x, (y+100) + lineHeight * 3);
			this.drawTextEx(dataEnemy.meta.desc5, x, (y+100) + lineHeight * 4);
		}
	};

...
Scene_Map.prototype.start = function() {
    ...
    ////
    //$gameSwitches.setValue(316,true);
...
Scene_Equip.prototype.create = function() {
    ...
    ////
    if ($gameActors.actor(1).hasArmor($dataArmors[20])) {
       $gameVariables.setValue(190, 1);
    } else {
       $gameVariables.setValue(190, 0);
    }
...
Scene_Equip.prototype.commandOptimize = function() {
    ...
    ////
    if ($gameActors.actor(1).hasArmor($dataArmors[20])) {
       $gameSwitches.setValue(314,false);
       $gameActors.actor(1).removeState(23);
       $gameVariables.setValue(83, Math.floor($gameVariables.value(83) / 2));
    } else {
       $gameSwitches.setValue(317,false);
...
Scene_Battle.prototype.changeInputWindow = function() {
    if (BattleManager.isInputting()) {
        ...
        if ($gameSwitches.value(73)) {
            ////
            if ($gameActors.actor(1).hasWeapon($dataWeapons[3]) || $gameActors.actor(1).hasWeapon($dataWeapons[4])) {
                if($gameParty.hasItem($dataItems[24])){
                    $gameScreen.showPicture(100,"Key-help3",0,198,486,100,100,255,0);
                } else {
                    $gameScreen.showPicture(100,"Key-help2",0,198,486,100,100,255,0);
                }
            } else {
                $gameScreen.showPicture(100,"Key-help1",0,198,486,100,100,255,0);
            }
            ...
            if ($gameActors.actor(1).hasWeapon($dataWeapons[3]) || $gameActors.actor(1).hasWeapon($dataWeapons[4])) {
                if($gameParty.hasItem($dataItems[24])){
                    $gameScreen.showPicture(100,"Key-help3-E",0,198,486,100,100,255,0);
                } else {
                    $gameScreen.showPicture(100,"Key-help2-E",0,198,486,100,100,255,0);
                }
            } else {
                $gameScreen.showPicture(100,"Key-help1-E",0,198,486,100,100,255,0);
            }
            $gameSwitches.setValue(56,true);
            ////
        }

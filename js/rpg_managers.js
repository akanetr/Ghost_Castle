...
BattleManager.endTurn = function() {
    ...
    ////
    //$gameTemp.reserveCommonEvent(ƒRƒ‚ƒ“ID);
    ////
...
BattleManager.displayDefeatMessage = function() {
    ...
    if ($gameVariables.value(83) < 100) {
       $gameSwitches.setValue(319,false);
    }
    ////
    if ($gameSwitches.value(319)) {
       $gameMessage.add(TextManager.defeat.format($gameParty.name()));
    } else {
       $gameMessage.add(TextManager.substitute.format($gameParty.name()));
    }
